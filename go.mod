...
require (
	...
	github.com/3scale/3scale-istio-adapter v0.6.1-0.20190514101004-63d025ce658c
	...
	github.com/uber/jaeger-client-go v0.0.0-20190228190846-ecf2d03a9e80 // indirect
